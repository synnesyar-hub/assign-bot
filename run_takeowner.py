...
from automation.auto_resolve import run_bot3_all_worksheets_parallel, goto_with_retry
from automation.lock_utils import check_can_run_standalone, release_lock

BOT_KEY = "takeowner"
BOT_LABEL = "Bot Take Owner (Bot-3)"
WORKSHEETS = ("Database", "Database2", "Database3")
CYCLE_SECONDS = 90 * 60  # 1 jam 30 menit
TAKEOWNER_WORKERS = 3
...
async def main():
    ...
    try:
        async with async_playwright() as p:
            ...
            pages = []
            for _ in range(TAKEOWNER_WORKERS):
            ...
            while True:
                ...
                await run_bot3_all_worksheets_parallel(pages, WORKSHEETS)
